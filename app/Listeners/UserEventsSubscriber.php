...
class UserEventsSubscriber
{
    ...
    public function onUserDetailsUpdate(UpdatedUserDetails $event)
    {
        $this->logger->log(trans('log.updated_user_details'));
    }
    ...
    public function subscribe($events)
    {
        ...
        $events->listen(UpdatedUserDetails::class, "{$class}@onUserDetailsUpdate");
