...
class RouteServiceProvider extends ServiceProvider
{
    ...
    private function bindCompany($router)
    {
        $router->model('company', Company::class);
    }

    private function bindMessage($router)
    {
        $router->model('message', Message::class);
    }

    private function bindNews($router)
    {
        $router->model('news', News::class);
    }

    private function bindCandidate($router)
    {
        $router->model('candidate', Candidate::class);
    }
