    ...
    <div class="form-wrap col-md-5 auth-form">
        <div style="text-align: center; margin-bottom: 25px;">
            ...
            <h1 class="page-header">
                <img src="{{ url('assets/img/icons/gtalents-logo.png') }}" alt="{{ settings('app_name') }}" style="width: 100%;margin-left: 0px;margin-top: -30px;"> REGISTER
            </h1>
        </div>
        ...
        <form role="form" action="<?= url('register') ?>" method="post" id="registration-form" autocomplete="off">
            ...
            <div class="form-group input-icon">
                ...
                {!! Form::select('country_id', $countries, old('country_id'), ['class' => 'form-control padding-icon', 'id' => 'country_id', 'placeholder' => trans('app.country'), 'required']) !!}
            </div>
