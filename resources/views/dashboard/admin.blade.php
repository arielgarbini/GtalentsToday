...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-widget panel-danger">
            ...
            <a href="{{ route('user.index', ['status' => \Vanguard\Support\Enum\UserStatus::BANNED]) }}">
                <div class="panel-footer">
                    <span class="pull-left">@lang('app.view_details')</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-widget panel-purple">
            ...
            <a href="{{ route('user.index', ['status' => \Vanguard\Support\Enum\UserStatus::UNCONFIRMED]) }}">
                <div class="panel-footer">
                    <span class="pull-left">@lang('app.view_details')</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                @if (count($latestRegistrations))
                    ...
                    <a href="{{ route('user.index') }}" class="btn btn-default btn-block">@lang('app.view_all_users')</a>
                @else
...
@section('scripts')
    <script>
        ...
        var trans = {
            ...
            new_plural: "{{ trans('app.new_plural') }}",
