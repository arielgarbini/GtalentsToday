            ...
            <section class="team-card">
                ...
                <section class="supplierContain1">
                    ...
                    <figure class="supplierContain1-ranking">
                        <img class="category-o tooltipped" src="/upload/categories/{{$supplier->supplier->company[0]->category->avatar}}" data-position="bottom" data-delay="50" data-tooltip="{{$supplier->supplier->company[0]->category->name}}">
                    </figure>
