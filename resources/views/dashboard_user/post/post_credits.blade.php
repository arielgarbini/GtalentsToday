...
<!--CONTENEDOR INDEX REGISTRADO-->
	<article class="user-main grid">
		...
		<section class="user-main-contain">
			...
			<!--ENVIAR CANDIDATOS CON CREDITOS-->
			<div class="btn-section hint--bottom  hint--large hint--bounce" aria-label="Enviar candidatos utilizando creditos gTalents">
				<a href="#modalnoLeidos" class="btn-main modal-trigger waves-effect waves-light">
					Enviar Candidato
				</a>
			</div>
	...
	<!--MODAL VER TODOS LOS CANDIDATOS-->
