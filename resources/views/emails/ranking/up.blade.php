            ...
            <table width="600px" cellspacing="0" cellpadding="0" border="0" class="responsive-table" style="border-radius: 6px;">
                ...
                <tr>
                    <td align="center" class="td-responsive" style="padding: 0 35px;">
                        <h2 style="font-family:Lato, helvetica,arial; font-size:20px; color : #3A6097; margin: 25px 0 0 0">
                            @lang('app.company_been_promoted')
                        </h2>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="td-responsive" style="padding: 0 80px;">
                        ...
                        <table cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                <td ><img style='height:40px; width:40px;' src='{{$category->embed(base_path("public/upload/categories/".$category->avatar))}}' ></td>
                                <td>
                                    <h4 style="margin: 5px">{{$category->name}}</h4>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table style="width: 100%" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                <th>
                                @lang('app.poster_percent')
                                </th>
                                <th>
                                @lang('app.supplier_percent')
                                </th>
                                <th>
                                @lang('app.gtalents_percent')
                                </th>
                            </tr>
                            <tr>
                                <td align="center">
                                {{$category->poster_percent}}%
                                </td>
                                <td align="center">
                                    {{$category->supplier_percent}}%
                                </td>
                                <td align="center">
                                    {{$category->gtalents_percent}}%
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td align="center" style="border-bottom: 1px solid #F2F2F2; padding: 15px 0px 35px 0px;">
                        <a href="{{ route('dashboard') }}" target="_blank" style="color:#ffffff;background:#73BF9B;padding:10px 12px;text-align:center;border-radius:5px;display:block;text-decoration:none;width:30%; font-size:14px;" class="cta">
