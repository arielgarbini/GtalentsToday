            ...
            <table width="600px" cellspacing="0" cellpadding="0" border="0" class="responsive-table" style="border-radius: 6px;">
                ...
                <tr>
                    <td align="center" class="td-responsive" style="padding: 0 35px;">
                        <h2 style="font-family:Lato, helvetica,arial; font-size:20px; color : #3A6097; margin: 25px 0 0 0">
                            @lang('app.user_activated', ['app' => settings('app.name')])
                        </h2>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="td-responsive" style="padding: 0 80px;">
                        ...
                        <p>@lang('app.enter_gtalents_description', ['app' => settings('app.name')])</p>

                        <a href="{{ route('loginuser') }}">@lang('app.enter_gtalents', ['app' => settings('app.name')])</a> <br/><br/>
                ...
                <tr>
                    <td align="center" style="border-bottom: 1px solid #F2F2F2; padding: 15px 0px 35px 0px;">
                        <a href="{{ route('loginuser') }}" target="_blank" style="color:#ffffff;background:#73BF9B;padding:10px 12px;text-align:center;border-radius:5px;display:block;text-decoration:none;width:30%; font-size:14px;" class="cta">
                            @lang('app.enter_gtalents', ['app' => settings('app.name')])
                        </a>
                    </td>
                </tr>
