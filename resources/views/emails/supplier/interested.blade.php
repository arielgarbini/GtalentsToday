            ...
            <table width="600px" cellspacing="0" cellpadding="0" border="0" class="responsive-table" style="border-radius: 6px;">
                ...
                <tr>
                    <td align="center" class="td-responsive" style="padding: 0 35px;">
                        <h2 style="font-family:Lato, helvetica,arial; font-size:20px; color : #3A6097; margin: 25px 0 0 0">
                            @lang('app.supplier_interested_participating') {{$vacancy->name}}
                        </h2>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="td-responsive" style="padding: 0 80px;">
                        ...
                        <table cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                <td rowspan="2"><img style='height:40px; width:40px;' src='{{$message->embed(base_path("public/upload/categories/".$supplier->company[0]->category->avatar))}}' ></td>
                                <td>
                                    <h4 style="margin: 5px">{{$supplier->code}}</h4>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p style="margin: 5px">{{$supplier->company[0]->category->name}}</p>
                                </td>
                            </tr>
                        </table>
                        <br>
                        <p class="parrafo" style="font-size:16px;  line-height:20px; color:#22203B;">
                        <p>@lang('app.see_more_details')</p>

                        <a href="{{ route('vacancies.show', $vacancy->id) }}">@lang('app.see_more_detail')</a> <br/><br/>

                        <p>@lang('app.if_you_cant_click')</p>

                        <p>{{ route('vacancies.show', $vacancy->id) }}</p>
                ...
                <tr>
                    <td align="center" style="border-bottom: 1px solid #F2F2F2; padding: 15px 0px 35px 0px;">
                        <a href="{{ route('vacancies.show', $vacancy->id) }}" target="_blank" style="color:#ffffff;background:#73BF9B;padding:10px 12px;text-align:center;border-radius:5px;display:block;text-decoration:none;width:30%; font-size:14px;" class="cta">
                            @lang('app.see_more_detail')
                        </a>
                    </td>
                </tr>
