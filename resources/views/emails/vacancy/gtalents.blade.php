            ...
            <table width="600px" cellspacing="0" cellpadding="0" border="0" class="responsive-table" style="border-radius: 6px;">
                ...
                <tr>
                    <td align="center" class="td-responsive" style="padding: 0 35px;">
                        <h3 style="font-family:Lato, helvetica,arial; font-size:20px; color : #3A6097; margin: 25px 0 0 0">
                            @lang('app.status_change_vacancy')
                            </h2><br>
                            <h3 style="font-family:Lato, helvetica,arial; font-size:16px; color : #3A6097; margin: 0px 0 0 0">{{$vacancy->name}}</h3>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="td-responsive" style="padding: 0 80px;">
                        ...
                        <p>@lang('app.status_vacancy') {{$data['status']}}</p>
                        <p>@lang('app.message_for_poster')</p>

                        <p>{{$data['message_supplier']}}</p>

                        <p>@lang('app.message_to_gtalents')</p>

                        <p>{{$data['message_gtalents']}}</p>
                ...
                <tr>
                    <td align="center" style="border-bottom: 1px solid #F2F2F2; padding: 15px 0px 35px 0px;">
                        <a href="{{URL::to('/')}}" target="_blank" style="color:#ffffff;background:#73BF9B;padding:10px 12px;text-align:center;border-radius:5px;display:block;text-decoration:none;width:30%; font-size:14px;" class="cta">
                            @lang('app.go_to_gtalents')
                        </a>
                    </td>
                </tr>
