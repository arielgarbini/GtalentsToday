...
@section('content')
    ...
    <article class="register">
        ...
        <!--FORMULARIO login-->
    {!! Form::open(['route' => ['completeData.collaborator', $token], 'files' => true, 'id' => 'form-confirm', 'class' => 'formLogin login']) !!}
    <!--PASO 1 | INFORMACION DE CONTAINER-->
        ...
        <div class="formContainer-confirm validate-one-input" id="paso1-1">
            ...
            <div class="itemForm">
                ...
                <input message="{{trans('app.password_required')}}" class='validate-one' type="password" name="password" id="password" placeholder="@lang('app.password')">
            </div>

            <!--CONFIRM PASSWORD-->
            <div class="itemForm">
                <label>@lang('app.confirm_password')</label>
                <input message="{{trans('app.password_confirm_required')}}" class='validate-one' type="password" name="password_confirmation" id="password_confirmation" placeholder="@lang('app.confirm_password')">
            </div>
