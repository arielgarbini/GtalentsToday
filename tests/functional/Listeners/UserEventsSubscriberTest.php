...
class UserEventsSubscriberTest extends BaseListenerTestCase
{
    ...
    public function test_onAvatarChange()
    {
        ...
        $this->assertMessageLogged('Updated user details avatar.');
    }

    public function test_onUserDetailsUpdate()
    {
        event(new \Vanguard\Events\User\UpdatedUserDetails);
        $this->assertMessageLogged('Updated user details.');
    }
